  ...
  return [
    ...
    rows: [
      ...
      },
      {
        ...
        amt_on_hand: chem2AmtinHand ?? "fetching data..",
        summary: scouringSummary2,
        cost_per_kg: chem2Cost ?? "fetching data..",
      ...
      },
      {
        ...
        amt_on_hand: chem3AmtinHand ?? "fetching data..",
        summary: scouringSummary3,
        cost_per_kg: chem3Cost ?? "fetching data..",
      ...
      },
      {
        ...
        amt_on_hand: chem4AmtinHand ?? "fetching data..",
        summary: scouringSummary4,
        cost_per_kg: chem4Cost ?? "fetching data..",
      ...
      },
      {
        ...
        amt_on_hand: chem5AmtinHand ?? "fetching data..",
        summary: scouringSummary5,
        cost_per_kg: chem5Cost ?? "fetching data..",
      ...
      },
      {
        ...
        amt_on_hand: chem6AmtinHand ?? "fetching data..",
        summary: scouringSummary6,
        cost_per_kg: chem6Cost ?? "fetching data..",
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        amt_on_hand: chem8AmtinHand ?? "fetching data..",
        summary: prepareToDyeSummary2,
        cost_per_kg: chem8Cost ?? "fetching data..",
      ...
      },
      {
        ...
        amt_on_hand: chem9AmtinHand ?? "fetching data..",
        summary: prepareToDyeSummary3,
        cost_per_kg: chem9Cost ?? "fetching data..",
      ...
      },
      {
        ...
        amt_on_hand: chem10AmtinHand ?? "fetching data..",
        summary: prepareToDyeSummary4,
        cost_per_kg: chem10Cost ?? "fetching data..",
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        amt_on_hand: dye2AmtinHand ?? "fetching data..",
        summary: dyeingSummary2,
        cost_per_kg: dye2Cost ?? "fetching data..",
      ...
      },
      {
        ...
        amt_on_hand: dye3AmtinHand ?? "fetching data..",
        summary: dyeingSummary3,
        cost_per_kg: dye3Cost ?? "fetching data..",
      ...
      },
      {
        ...
        amt_on_hand: dye4AmtinHand ?? "fetching data..",
        summary: dyeingSummary4,
        cost_per_kg: dye4Cost ?? "fetching data..",
      ...
      },
      {
        ...
        amt_on_hand: dye5AmtinHand ?? "fetching data..",
        summary: dyeingSummary5,
        cost_per_kg: dye5Cost ?? "fetching data..",
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        amt_on_hand: finishingChem2AmtinHand ?? "fetching data..",
        summary: finishingSummary2,
        cost_per_kg: finishingChem2Cost ?? "fetching data..",
      ...
      },
      {
        ...
        amt_on_hand: finishingChem3AmtinHand ?? "fetching data..",
        summary: finishingSummary4,
        cost_per_kg: finishingChem3Cost ?? "fetching data..",
