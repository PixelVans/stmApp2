...
const WeavingProductionPrintout26 = forwardRef((props, ref) => {
  const { steps, summary, loading, error } = useProductionSteps26();
    ...
    return (
      <div className="flex flex-col mt-[-100px] items-center justify-center h-screen">
        ...
        <p className="mt-4 text-lg font-medium text-gray-700">
            Loading Weaving production — Week {selectedWeek} ({selectedYear})
            </p>
...
export default WeavingProductionPrintout26;
