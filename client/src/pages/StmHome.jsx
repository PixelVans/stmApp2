...
export default function StmHome() {
  return (
    <div className="flex flex-col min-h-screen bg-white text-gray-900 mt-[-100px]">
      {/* Main Content */}
      <main className="flex flex-1 flex-col items-center justify-center text-center space-y-2 px-6">
        <motion.div
          initial={{ scale: 0.8, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
        >
          <FaHome className="h-12 w-12 sm:h-16 sm:w-12 text-blue-700 animate-bounce" />
        </motion.div>
        ...
        >
          Welcome to <span className="text-blue-700">STM Home</span>
        </motion.h1>
